...
const requests = {
    tv: {
        ...
        helpers: {
			...
			fetchTVImages: `/tv/{{tv_id}}/images?api_key=${API_KEY}`,
    ...
    movies: {
        ...
        helpers: {
			fetchNetflixOriginals: `/discover/movie?api_key=${API_KEY}&with_watch_providers=8`,
			...
			fetchMovieImages: `/movie/{{movie_id}}/images?api_key=${API_KEY}`,
